...
# ====== 1. Baca file CSV hasil simulasi ======
df = pd.read_csv("data_traffic.csv", parse_dates=["timestamp"])
...
# Contoh prediksi untuk Senin, 26 Mei 2025, pukul 18:30
...
print(f"Prediksi jumlah orang pada {future_time.strftime('%A, %d %B %Y %H:%M')} adalah sekitar {prediction[0]:.0f} orang.")
